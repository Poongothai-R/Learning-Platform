...
export default function AddCourse() {
    const [form, setForm] = useState({
        courseName: "", courseDesc: "", courseImage: null, docFiles: null, videoFiles: null });
    ...
    return (
        <div id="addcourse">
            <div className="addcourse-page">
                ...
                <form className="addcourse-form" id="addCourseForm"
                    ...
                    <button className="course-cancel-btn" id="addCourse-cancel" onClick={() => cancelform()}>
                        Cancel
                    </button>
                </form>
            </div>
