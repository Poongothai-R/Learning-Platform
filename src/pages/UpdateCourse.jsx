...
export default function UpdateCourse() {
    const [form, setForm] = useState({ courseName: "",
        courseDesc: "", courseImage: null, docFiles: null, videoFiles: null });
    ...
    return (
        <div id="updatecourse">
            <div className="updatecourse-page">
                ...
                <form className="updatecourse-form" id="updateCourseForm" onSubmit={
                    ...
                    <button className="update-cancel-btn" id="updateCourse-cancel" onClick={() => cancelform()}>
                        Cancel
                    </button>
                </form>
            </div>
