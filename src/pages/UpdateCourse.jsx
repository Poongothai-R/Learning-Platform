...
export default function UpdateCourse() {
  ...
  // no need to useEffect to update the date, in fact this can lead to bugs
  useEffect(() => {
    setForm({
  ...
  return (
    <div id="updatecourse">
      <div className="updatecourse-page">
        ...
        <form
          className="updatecourse-form"
          id="updateCourseForm"
          onSubmit={(event) => onSubmit(event)}
        >
          <FormFieldGenerator data={courseFields} state={[form, setForm]} />
          <button className="course-update-btn" id="updateCourse-btn">
            submit
          </button>
          <button
            className="update-cancel-btn"
            id="updateCourse-cancel"
            onClick={() => cancelform()}
          >
            Cancel
          </button>
